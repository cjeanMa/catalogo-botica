  ...
  <script type="text/javascript" src="<?=base_url()?>assets/theme/vendor/jquery/jquery.min.js"></script>
  <script type="text/javascript" src="<?=base_url()?>assets/theme/vendor/bootstrap/js/bootstrap.bundle.min.js"></script>
